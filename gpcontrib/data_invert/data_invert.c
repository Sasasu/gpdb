...
#include "cdb/cdbbufferedappend.h" // for ao write hook
#include "cdb/cdbbufferedread.h"   // for ao read hook
...
static ao_file_read_hook_type  pre_ao_file_read_hook  = NULL;
static ao_file_write_hook_type pre_ao_file_write_hook = NULL;
...
_PG_init(void)
{
	...
	ao_file_read_hook     = ao_file_read_hook_invert;

	pre_ao_file_write_hook = ao_file_write_hook;
	ao_file_write_hook     = ao_file_write_hook_invert;
}
