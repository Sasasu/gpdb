					 ...
					 TimeLineID *pageTLI)
{
	...
	{
		XLogSegNo segNO;
		XLByteToSeg(targetPagePtr, segNO, state->wal_segment_size);
		(*encryption_xlog_read_hook)(cur_page, XLOG_BLCKSZ, XLogSegmentOffset(targetPagePtr, state->wal_segment_size), segNO);
	}
